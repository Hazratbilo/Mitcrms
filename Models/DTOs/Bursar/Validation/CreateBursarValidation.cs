...
namespace MITCRMS.Models.DTOs.Bursar.Validation
{
    public class CreateBursarValidation : AbstractValidator<CreateBursarRequestModel>
    {
        public CreateBursarValidation()
        {
